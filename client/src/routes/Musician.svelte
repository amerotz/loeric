<script lang="ts">
	...
	async function droningChange(event: Event) {
		...
		await apiPut("drones", {id: musician.id, drones: input.checked})
	}
...
<style lang="postcss">
	...
	input[type=range]::-webkit-slider-thumb {
		...
		cursor: pointer;
				...
				<div class="p-3 shadow-lg rounded-2xl bg-gray-800 flex gap-2">
<div class="place-self-center min-w-1/3 texwjlg bg-gray-700 p-5 rounded-2xl h-full">
	<div class="flex px-1">
	...
	<label class="flex flex-col">
		<span class=" px-1 opacity-60">Instrument</span>
	...
	<label class="flex flex-col">
		<span class=" px-1 opacity-60">Output</span>
	...
	<label class="flex flex-col">
		<span class="px-1 opacity-60">Input</span>
	...
	<label>
		...
		<input type="checkbox" checked onchange={droningChange}>
	</label>

</div>
	<div class="flex py-5 shadow-lg justify-evenly rounded-2xl bg-gray-700 w-full">
